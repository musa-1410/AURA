...
const MyBookings = () => {
  ...
  // Filter out past bookings (only show future/current bookings)
  const now = new Date();
    ...
    <div className="container">
      ...
      <div className="bookings-stats">
        <div className="stat-item">
          <span className="stat-label">Total Active Bookings:</span>
          <span className="stat-value">{activeBookings.length}</span>
        </div>
        <div className="stat-item">
          <span className="stat-label">Approved:</span>
          <span className="stat-value approved">
            {activeBookings.filter(b => b.status === 'approved').length}
          </span>
        </div>
        <div className="stat-item">
        ...
        <div className="stat-item">
          ...
          <span className="stat-value rejected">
            {activeBookings.filter(b => b.status === 'rejected').length}
          </span>
        </div>
      </div>
    </div>
